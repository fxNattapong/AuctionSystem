                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav navbar-margin">
                        <li class="navbar-item">
                            <a class="nav-link text-white" href="Home.php">CENTER AUCTION SYSTEM</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="col col-lg-6 mb-4 mb-lg-0">
                        <div class="card mb-3" style="border-radius: .5rem;">
                            <div class="row g-0">
                                ...
                                <p>Welcome</p>
                                <a><?php echo $objResult["member_fullname"]; ?></a>
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-6 mb-3">
                                                <h6>FULLNAME</h6>
                                                <p class="text-muted"><?php echo $objResult["member_fullname"]; ?></p>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <h6>CONTACT</h6>
                                                <p class="text-muted"><?php echo $objResult["member_contact"]; ?></p>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <h6>ADDRESS</h6>
                                                <p class="text-muted"><?php echo $objResult["member_address"]; ?></p>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <h6>EMAIL</h6>
                                                <p class="text-muted"><?php echo $objResult["member_email"]; ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-6 mb-3">
                                                <h6>Username</h6>
                                                <p class="text-muted"><?php echo $objResult["member_username"]; ?></p>
                                            </div>
                                            <div class="col-6 mb-3">
                                                <h6>Password</h6>
                                                <p class="text-muted"><?php echo $objResult["member_password"]; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                            ...
                            <div class="card-header-main"><b style="font-size: 20px">CATEGORIES</b></div>
                                <div class="card-body frame-main">
                                    <ul class='list-group' id='cat-list'>
                                        <li class='list-group-item' data-id='all' data-href="Categories.php?page=home&category_id=all">ALL</li>
                                        <?php
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                            ...
                                            $expire = $objConnect->query("SELECT * FROM products WHERE unix_timestamp(product_end_bid) < ".strtotime(date("Y-m-d H:i"))." $where ORDER BY product_name ASC");
                                            if($expire->num_rows > 0){
                                                while($row = mysqli_fetch_assoc($expire)) {
                                                    ...
                                                    // if($payment_data['payment_bid_id'] != $bid_user_id_data['bid_id']) {
                                            ...
                                            $cat = $objConnect->query("SELECT * FROM products WHERE unix_timestamp(product_end_bid) >= ".strtotime(date("Y-m-d H:i"))." $where ORDER BY product_name asc");
                                            if($cat->num_rows <= 0){
